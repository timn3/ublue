...
dnf5 -y install --skip-unavailable hyprlauncher wireplumber upower libgtop2 bluez bluez-tools grimblast hyprpicker btop NetworkManager wl-clipboard swww brightnessctl gnome-bluetooth aylurs-gtk-shell2 gvfs nodejs wf-recorder
